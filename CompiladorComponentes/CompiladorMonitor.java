...
public class CompiladorMonitor {
    ...
    public ArrayList<Monitor> seleccionar() {
        Connection con = null;
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Monitor = new Monitor(numeroSerie, nombrecomponente, marcafabricante, precio, impuesto, descripcion);
