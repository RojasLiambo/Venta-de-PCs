...
public class CompiladorMemoriaRam {
    ...
    public ArrayList<MemoriaRAM> seleccionar() {
        Connection con = null;
        PreparedStatement stmt = null;
        ResultSet rs = null;
        MemoriaRAM memoriaram = null;
        ArrayList<MemoriaRAM> memorias = new ArrayList();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                memoriaram = new MemoriaRAM(numeroSerie, nombrecomponente, marcafabricante, precio, impuesto, descripcion);
                memorias.add(memoriaram);
            }
